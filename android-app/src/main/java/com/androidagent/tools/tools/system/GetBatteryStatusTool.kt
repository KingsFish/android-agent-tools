...
class GetBatteryStatusTool : Tool {
    ...
    override suspend fun execute(context: ToolContext, params: Map<String, Any?>): ToolResult {
        ...
        return try {
            ...
            val batteryStatus = androidContext.registerReceiver(null, intentFilter)
            ...
            ToolResult.failure(ToolError.UNSUPPORTED_OPERATION, "Failed to get battery status: ${e.message}")
        }
    }
}